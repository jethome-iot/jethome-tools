...
RECOVERY_VERSION="${RECOVERY_VERSION:-v0.0.4}"
RECOVERY_SHA256_J100="${RECOVERY_SHA256_J100:-709b3b605f19da71c1062a2e46ee0c2b8aa8df06a59efe78ec7c3e101ca100cc}"
RECOVERY_SHA256_J310="${RECOVERY_SHA256_J310:-de716b4fc5a6ca5d1234beb72b0893eb269b5404680b5e043228744e8ec49ae3}"
