...
RECOVERY_VERSION="${RECOVERY_VERSION:-v0.2.1}"
RECOVERY_SHA256_J100="${RECOVERY_SHA256_J100:-e8f9fa4cd9672248063f688327a44472d18142e3cb39681c339bfc66d247776a}"
RECOVERY_SHA256_J310="${RECOVERY_SHA256_J310:-15b3f03a61b2ddea395730852320f3ab236197c10001e4cdda279ef2a3f2aa61}"
